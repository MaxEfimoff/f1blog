...
router.post('/unlike/:id', passport.authenticate('jwt', {session: false}), unlikeNewsItem);
router.post('/comment/:id', passport.authenticate('jwt', {session: false}), postNewsItemComment);

router.patch('/:id/update-news', passport.authenticate('jwt', {session: false}), updateNewsItem);
router.delete('/', passport.authenticate('jwt', {session: false}), deleteNewsItem);
router.delete('/comment/:id/:comment_id', passport.authenticate('jwt', {session: false}), deleteNewsItemComment);
